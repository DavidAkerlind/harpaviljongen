	...
	return (
		<article id="chambreMenu" className="chambre-menu">
			<section className="chambre-menu__courses">
				<FadeIn>
					<article className="chambre-menu__course">
						...
						<p className="chambre-menu__course-text">
							...
							<strong>charkuterier</strong> från vår Berkel Volano
							P15 – ett startskott med både hantverk och tradition
							i varje skiva.
						</p>
						<p className="chambre-menu__course-text">
							Därefter serveras vår signatur: en{' '}
							<strong>krokett</strong> på Västerbottensost, toppad
							med exklusiv störcaviar.
						</p>
						<p className="chambre-menu__course-text">
							<strong>Toast Skagen</strong>, serverad på smörstekt
							bröd från Två Systrars Bageri, generöst toppad med
							Kalix löjrom.
						</p>
					</article>
				</FadeIn>
				<FadeIn>
					<article className="chambre-menu__course">
						<h3 className="chambre-menu__course-title">
							HUVUDRÄTT
						</h3>
						<p className="chambre-menu__course-text">
							Välj mellan:
						...
						<ul className="chambre-menu__course-list">
							...
							<li className="chambre-menu__course-list-item">
								<strong>Piggvar på benet</strong> – varsamt
								tillagad med noggrant utvalda ackompanjemang
							</li>
						</ul>
					</article>
				</FadeIn>
				<FadeIn>
					<article className="chambre-menu__course">
						...
						<p className="chambre-menu__course-text">
							Varm <strong>Tarte Tatin</strong> på Calvados,
							serverad med len vaniljglass
						</p>
					</article>
				</FadeIn>
			</section>
			...
			<FadeIn>
				<section className="chambre-menu__footer">
					<p className="chambre-menu__footer-text">
						Vi inspireras av det franska köket, men låter även våra
						egna minnen, favoriter och smaker få ta plats. Hos oss
						är chambre séparée inte bara ett rum – det är en
						upplevelse. <br />
						<br />
